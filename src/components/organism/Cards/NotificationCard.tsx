...
export default function NotificationCard({ data }: Props) {
    ...
    return (
        <Box
            className="notification__item flex flex-wrap gap-3 py-1.5 px-0 lg:px-4 lg:py-3.5 2xl:py-6 2xl:px-6 cursor-pointer last:border-b-0!"
            sx={{
        ...
        >
            ...
            <div className="notification__content flex-1">
                <div className="flex mb-1.5 justify-between items-start gap-4">
                    <Typography variant="h6" color="primary" fontWeight={500} className="line-clamp-1 leading-6!">
                        {data.title}
                    </Typography>
                ...
                <Typography variant="subtitle2" color="text.dark" className="line-clamp-2 leading-4!">
