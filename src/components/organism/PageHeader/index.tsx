                    ...
                    sx={(theme) => ({
                        ...
                        "& .breadcrumb__item": {
                            ...
                            "&:not(:last-child)": {
                                ...
                                "a svg path": {
                                    fill: theme.palette.text.disabled || theme.palette.text.middle
                                }
                            },
                            "&:last-child": {
                    ...
                    {breadcrumb && breadcrumb.map((item) => (
                        <div className="breadcrumb__item" key={item.title}>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="9" height="18" viewBox="0 0 9 18" fill="none">
                                <path d="M0.75 16.59L7.27 10.07C8.04 9.3 8.04 8.04 7.27 7.27L0.75 0.75" stroke="#6B7280" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </div>
                    ))}
                </Stack>
