...
import { TICKET_PRIORITY_OPTIONS } from "../../../../types/ticket";
...
export default function TicketForm({ open, onClose, onSuccess }: Props) {
	...
	const { data: typesData } = useGetTicketTypesQuery({});
			...
			<form onSubmit={formik.handleSubmit}>
				<DialogContent dividers>
					<div className="flex flex-col gap-4 md:grid md:grid-cols-2">
						...
						<div className="col-span-1">
							<InputLabel className="required">Priority</InputLabel>
							<Select
								fullWidth
								name="priority"
							...
							{formik.touched.priority && formik.errors.priority && (
								<FormHelperText error={true}>{formik.errors.priority}</FormHelperText>
							)}
						</div>
						<div className="col-span-2">
