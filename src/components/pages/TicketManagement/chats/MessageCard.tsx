...
import { getTicketPriorityVariant, getTicketStatusVariant } from "../../../../utils/statusMap";
                ...
                <Stack direction="row" gap={0.5} flexWrap="wrap" alignItems="center" mb={0.5}>
                    {ticket.status && (
                        <Chip
                            ...
                            color={getTicketStatusVariant(ticket.status)}
                            variant="outlined"
                            sx={{ height: 20, fontSize: 11 }}
                        />
                    )}
                    {priorityLabel && (
                        <Chip label={priorityLabel} color={getTicketPriorityVariant(ticket.priority || "low")} size="small" variant="outlined" sx={{ height: 20, fontSize: 11 }} />
                    )}
                    {departmentLabel && (
