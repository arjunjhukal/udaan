...
export default function TransactionManagementForm({ open, setOpen, transactionId }: Props) {
    ...
    return (
        <Dialog open={open} onClose={handleClose}
            ...
            <DialogContent className="flex flex-col gap-6" sx={{
                ...
                {loadingTransaction ? (
                    ...
                    <>
                        ...
                        <form onSubmit={formik.handleSubmit}>
                            ...
                            {/* Action Buttons */}
                            <Box className="flex justify-end gap-4 mt-6 sticky bottom-0 left-0 right-0" bgcolor={theme.palette.primary.contrastText}>
