import { Dialog, DialogContent, Divider, FormHelperText, IconButton, InputLabel, OutlinedInput, Typography, useTheme } from '@mui/material';
...
export default function CurriculumFormWithoutMedia({ open, setOpen, selectedPlan }: Props) {
