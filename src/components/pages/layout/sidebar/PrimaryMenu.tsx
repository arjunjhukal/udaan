...
export default function PrimaryMenu() {
    ...
    const isChildActive = (basePath: string) => location.pathname.startsWith(basePath);
        ...
        <Box sx={{ padding: "0 32px 32px" }}>
            ...
            <List>
                        ...
                        <List component="div" disablePadding sx={{ pl: 3 }}>
                            <ListItem disablePadding>
                                ...
                                >
                                    ...
                                    <ListItemText primary={t("menus.category_management.mega_category.root")} />
                                </ListItemButton>
                            </ListItem>
                            <ListItem disablePadding>
                                <ListItemButton
                                ...
                                >
                                    <ListItemIcon><DashboardIcon /></ListItemIcon>
                                    <ListItemText primary={t("menus.category_management.category.root")} />
                                </ListItemButton>
                            </ListItem>
                            ...
                            <ListItem disablePadding>
                                ...
                                >
                                    <ListItemIcon><DashboardIcon /></ListItemIcon>
                                    <ListItemText primary={t("menus.category_management.sub_category.root")} />
                                </ListItemButton>
                            </ListItem>
                            ...
                            <ListItem disablePadding>
                                <ListItemButton
                                    ...
                                    className={isActive('/category/position') ? 'active-nested' : ''}
                                >
                                    <ListItemIcon><DashboardIcon /></ListItemIcon>
                                    <ListItemText primary={t("menus.category_management.position.root")} />
                                </ListItemButton>
                            </ListItem>
                        </List>
                    </Collapse>
                ...
                <ListItem disablePadding>
                    ...
                    >
                        <ListItemIcon><DashboardIcon /></ListItemIcon>
                        <ListItemText primary={t("menus.teachers.root")} />
                    </ListItemButton>
                </ListItem>
            </List>
        </Box>
