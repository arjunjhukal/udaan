...
export default function NotificationBell() {
    ...
    const { unreadCount, resetUnread } = useAdminNotification();
    ...
    const hasMore = pagination ? qp.pageIndex < pagination.total_pages : false;
    const hasUnread = unreadCount > 0 || notifications.some((n) => !n.has_seen);
    ...
    const handleReadAll = async () => {
        try {
            ...
            dispatch(showToast({ message: e?.data?.message || "Something went wrong", severity: "error" }));
        }
    };
    ...
    return (
        <>
            ...
            >
                ...
                >
                    <Notification size={18} variant="Bold" color={theme.palette.separator.darkest} />
                </Box>
            </Badge>
                            ...
                            <ClickAwayListener onClickAway={handleClose}>
                                <Box className="p-4 md:w-[520px]">
                                    ...
                                    <Box className="flex items-center justify-between">
                                        <Typography variant="h5" fontWeight={500}>Notifications</Typography>
                                        <Button variant="text" onClick={handleReadAll}>
                                            <Typography variant="subtitle2" fontWeight={400}>Mark all as read</Typography>
                                        </Button>
                                    </Box>
                                    ...
                                    {/* Scrollable list */}
                                    <Box id="notification-scroll" sx={{ maxHeight: 510, overflow: "auto" }}>
