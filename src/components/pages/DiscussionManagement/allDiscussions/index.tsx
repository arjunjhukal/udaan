...
export default function AllDiscussions() {
	...
	const canCreate = userPermissions.includes("add_discussions");
	...
	// const selectStatus = (s: "" | "visible" | "hidden") => {
	// 	setStatusFilter(s);
	// 	setQp((p) => ({ ...p, pageIndex: 1 }));
	// };

	// const statusOptions: { value: "" | "visible" | "hidden"; label: string }[] = [
	// 	{ value: "", label: t("labels.all") },
	// 	{ value: "visible", label: t("labels.visible") },
	// 	{ value: "hidden", label: t("labels.hidden") },
	// ];
